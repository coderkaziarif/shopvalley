...
import { Alert, Avatar, Button, Checkbox, FormControlLabel, Grid, Paper, TextField, Typography } from '@mui/material';
...
const Signup = () => {
   ...
   const handleSubmit = (e) => {
      ...
      if(actualData.name && actualData.email && actualData.password && actualData.confirm_Password && actualData.tc !== null){
         setError({status:true, msg:"Account Create Successfully.", type:"success"})
   ...
   return (
      <>
      <Grid component="form" id="signup_form" noValidate onSubmit={handleSubmit}>
         <Paper style={paperStyle}>
            ...
            <form style={{marginTop:"15px"}}>
               ...
               <TextField variant ="standard" type="password" name="confirm_Password"  label='Confirm password' placeholder="Confirm password" fullWidth required color='secondary'></TextField>

               <FormControlLabel sx={{marginTop:"8px"}} control={<Checkbox value="agree" name="tc" id="tc" color="secondary" size="small"/>}
               label="I accept the terms and condition."/>

               <Button type='submit' onClick={(e)=> console.log('clicked')} variant='contained' color='secondary' fullWidth style={{margin:"8px 0"}}>Sign up</Button>
